...
import {BsCart3, BsHeartFill, BsChevronDown, BsHeart, BsPerson, BsSearch, BsStopCircle} from "react-icons/bs"
...
var name1 = "KBis", name2="Nana", name3="Vinci";
    ...
    return (
        <>
            ...
            <div
                ...
                className="wrapper space-bt"
            >
                <div
                    className="wrapper"
                >
                    <img  src={sample_image1} style={{
                        width:400,
                        //height:300
                    }} />
                </div>
            ...
            <div
                ...
                className="wrapper"
            >
                <div className="wrapper"><img src={puma} width={80} /></div>
                <div className="wrapper"><img src={nike} width={80} height={50} /> </div>
                <div className="wrapper"><img src={converse}  width={80} height={30} style={{marginTop:10}} /></div>
                <div className="wrapper"><img src={vans} width={80} height={30} style={{marginTop:10}} /></div>
                <div className="wrapper"><img src={birk} width={100} height={40} style={{marginTop:5}} /></div>
                <div className="wrapper"><img src={addidas} width={80} height={50} /></div>
        ...
        <Link  to="/" className="link" style={{marginLeft:10,fontSize:"80%",textTransform:"none",fontWeight:600}} >See more of these</Link>
        </h2>
                    ...
                    <div>
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <div style={{width:30,lineHeight:1.5,marginLeft:15,fontWeight:"bold",color:"#fff"}}>
                                    STEP IT UP WITH US
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <div style={{width:30,lineHeight:1.5,marginRight:45,fontWeight:"bolder",color:"#fff",textShadow:10}}>
        ...
        <h2 style={{
            ...
            marginRight:10,
            marginTop:"4rem"
        }} >Hot picks for you. Let your feet talk</h2>
        <div className="flex" style={{marginLeft:10,marginBottom:30}}> <span className="vertical-line"></span> </div>
        <ScrollSpace dotSize={7} dotPosition="bottom" maxPixelSpace={350} maxFittingContent={5} direction="row" styles={{
            marginTop:10,
            marginLeft:10,
...
var s =0,zx=false;
 function BrandProducts({productName,cost,imageSrc,styles,key,previousCost,showButtons,num,category,brand}){
    ...
    Element:function E(){
        ...
        return (
            <div key={key+""+s} className="brand-product" style={{
                // display:"flex",
                ...
                <div style={{
                    ...
                    <div className="flex space-bt" >
                        <span>
                        GHS {cost} {previousCost?<span style={{fontWeight:"normal",textDecoration:"line-through",fontSize:"80%"}}>GHS {previousCost*4}</span>:null}
                        </span>
                        <div 
                            onClick={()=>{
                        ...
                        >
                            {
                               !showButtons?null:wishListed?<BsHeartFill fontSize={23} color="red" transform={heartScale?"scale(1.2)":"scale(1)"} />:<BsHeart fontSize={23} color="red" />
                            }
                        </div>
                    </div>
                </div>
