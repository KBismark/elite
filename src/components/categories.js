    ...
    <>
      ...
      <div className="flex">
        ...
        <div className="wrapper">
          ...
          {products.length > 0 ? (
            products.map((el) => <el.Element />)
          ) : (
            <h2 style={{ margin: "9rem 0px", textTransform: "uppercase" }}>
              No Product Matched. Please Refilter Results or Reload the Page
            </h2>
          )}
          <div
            style={{ width: "100%", padding: 20, fontWeight: 700 }}
            className="flex space-bt"
          >
